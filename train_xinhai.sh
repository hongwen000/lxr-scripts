...
pretrained_model="./sd-models/Chilloutmix-Ni.safetensors" # base model path | 底模路径
train_data_dir="./train/xinhai" # train dataset path | 训练数据集路径
...
output_name="xinhai-chillout" # output model name | 模型保存名称
